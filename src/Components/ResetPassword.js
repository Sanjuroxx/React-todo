...
export const ResetPassword = () => {
    ...
    const resetPassword=(e)=>{
      ...
      axios.post("http://localhost:3001/reset",data).then(res=>{
              ...
              <div className="col-md-6 col-lg-7 d-flex align-items-center">
                <div className="card-body p-4 p-lg-5 text-black">
                  <form onSubmit={resetPassword}>
                    ...
                    <div className="form-outline mb-4">
                      <input type="password" id="form2Example27" className="form-control form-control-lg" placeholder='Enter New Password' onChange={(e)=>{setpassword(e.target.value)}}/>
                      <label className="form-label" htmlFor="form2Example27"></label>
                    </div>
                    <div className="pt-1 mb-4">{
                     email && password ? <button className="btn btn-dark btn-lg btn-block" type="submit">Reset Password</button> :<button className="btn btn-dark btn-lg btn-block" type="submit" disabled>Reset Password</button>
                    } {/* <ToastContainer
  position="top-right"
    autoClose={1800}
