  ...
  <div className="container">
    ...
    <div className="row" data-aos="fade-up" data-aos-delay={200}>
      <div className="col-lg-4 col-md-6 service-item">
        <div className="service-icon"><i className="bi bi-briefcase" /></div>
      ...
      <div className="col-lg-4 col-md-6 service-item">
        <div className="service-icon"><i className="bi bi-card-checklist" /></div>
      ...
      <div className="col-lg-4 col-md-6 service-item">
        <div className="service-icon"><i className="bi bi-bar-chart" /></div>
      ...
      <div className="col-lg-4 col-md-6 service-item">
        <div className="service-icon"><i className="bi bi-binoculars" /></div>
      ...
      <div className="col-lg-4 col-md-6 service-item">
        <div className="service-icon"><i className="bi bi-brightness-high" /></div>
      ...
      <div className="col-lg-4 col-md-6 service-item">
        <div className="service-icon"><i className="bi bi-calendar4-week" /></div>
